...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	...
	return &PublicSettings{
		...
		SiteLogo:                         s.getStringOrDefault(settings, SettingKeySiteLogo, defaultBrandSiteLogo),
		SiteSubtitle:                     s.getStringOrDefault(settings, SettingKeySiteSubtitle, defaultBrandSiteSubtitle),
		APIBaseURL:                       s.getStringOrDefault(settings, SettingKeyAPIBaseURL, defaultBrandAPIBaseURL),
		ContactInfo:                      settings[SettingKeyContactInfo],
		DocURL:                           s.getStringOrDefault(settings, SettingKeyDocURL, defaultBrandDocURL),
		...
		BalanceLowNotifyRechargeURL:      s.getStringOrDefault(settings, SettingKeyBalanceLowNotifyRechargeURL, defaultBrandBalanceTopUpURL),
...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeySiteLogo:                                  defaultBrandSiteLogo,
		SettingKeySiteSubtitle:                              defaultBrandSiteSubtitle,
		SettingKeyAPIBaseURL:                                defaultBrandAPIBaseURL,
		SettingKeyDocURL:                                    defaultBrandDocURL,
		SettingKeyBalanceLowNotifyRechargeURL:               defaultBrandBalanceTopUpURL,
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	result.BalanceLowNotifyRechargeURL = s.getStringOrDefault(settings, SettingKeyBalanceLowNotifyRechargeURL, defaultBrandBalanceTopUpURL)
