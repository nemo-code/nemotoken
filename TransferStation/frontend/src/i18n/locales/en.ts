export default {
  ...
  // Setup Wizard
  setup: {
    title: 'NemoToken Setup',
    description: 'Configure your NemoToken instance',
    database: {
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. transferstation-backups), choose a region',
    ...
    accounts: {
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another transferstation instance.',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for NemoToken end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for NemoToken end-user login',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to NemoToken',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the NemoToken AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
